...
ADDON_SCRIPT="https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/tools/addon/dokploy.sh)"
MIGRATION_EOF
