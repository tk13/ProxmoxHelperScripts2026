...
ADDON_SCRIPT="https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/tools/addon/komodo.sh)"
MIGRATION_EOF
