...
ADDON_SCRIPT="https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/tools/addon/coolify.sh)"
MIGRATION_EOF
