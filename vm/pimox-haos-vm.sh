...
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/misc/api.func)
...
<div align='center'>
  <a href='https://community-scripts.org' target='_blank' rel='noopener noreferrer'>
    <img src='https://raw.githubusercontent.com/tk13/ProxmoxHelperScripts2026/main/misc/images/logo-81x112.png' alt='Logo' style='width:81px;height:112px;'/>
  </a>
